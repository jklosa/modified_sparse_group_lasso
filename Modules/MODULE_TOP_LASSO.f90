...
!**********************************************************
!**                                                      **
!**     ---- MODULE_TOP_LASSO.f90 ----                   **
!**                                                      **
!**     This module contains the following subroutines   **
!**     to solve the minimization problem:               **
!**       - ROUTINE_LASSO_PROX_GRAD_BACK_WARM            **
!**                                                      **
...
!**     with the following lasso algorithm:              **
!**                                                      **
!**       Proximal gradient descent with backtracking    **
!**       line search and warm starts                    **
!**                                                      **
!**********************************************************
  subroutine ROUTINE_LASSO_PROX_GRAD_BACK_WARM( &
             & n, &
             & p, &
             & ITERATION_MAX, &
             & NUMBER_INTERVALS, &
    ...
    !******************************************************
    integer(ik4), intent(in)                :: n, p, ITERATION_MAX, NUMBER_INTERVALS
    ...
    !******************************************************
    integer(ik4), save                    :: i, j, COUNTER, io_error
    ...
    PLACE_ERROR         = 'ROUTINE_LASSO_PROX_GRAD_BACK_WARM'
  	  ...
  	  LOOP_ACCURACY_ITERATION: do while ((.NOT. ACCURACY_REACHED) .AND. (COUNTER .LE. ITERATION_MAX))
  	  	...
  	  	LOOP_CRITERION: do while (.NOT. CRITERION_FULFILLED)
  	  		...
  	  		LOOP_FILL_TEMP_1: do j=1_ik4,p
  	  			...
  	  			VECTOR_TEMP2(j) = LAMBDA*real(n,rkdp)*t*VECTOR_OMEGA_FEATURE(j)
  ...
  end subroutine ROUTINE_LASSO_PROX_GRAD_BACK_WARM
end module MODULE_TOP_LASSO