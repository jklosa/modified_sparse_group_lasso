...
!**********************************************************
!**                                                      **
!**     ---- MODULE_TOP_SPARSE_GROUP_LASSO.f90 ----      **
!**                                                      **
!**     This module contains the following subroutines   **
!**     to solve the minimization problem:               **
!**       - ROUTINE_SP_GR_LASSO_PROX_GRAD_BACK_WARM      **
!**                                                      **
...
module MODULE_TOP_SPARSE_GROUP_LASSO
...
!**                                                      **
!**********************************************************
  subroutine ROUTINE_SPARSE_GROUP_LASSO_PROX_GRAD_BACK_WARM( &
             & n, &
             & p, &
             & NUMBER_GROUPS, &
             & ITERATION_MAX, &
    ...
    PLACE_ERROR         = 'ROUTINE_SP_GR_LASSO_PROX_GRAD_BACK_WARM'
    ...
    LOOP_LAMBDA: do i=1_ik4,NUMBER_INTERVALS
      ...
      LOOP_ACCURACY_ITERATION: do while ((.NOT. ACCURACY_REACHED) .AND. (COUNTER .LE. ITERATION_MAX))
        ...
        LOOP_CRITERION: do while (.NOT. CRITERION_FULFILLED)
          ...
          !* groupwise soft-thresholding and soft-scaling to obtain beta_new
          LOOP_GROUPS: do k=1_ik4,NUMBER_GROUPS
            ...
            LOOP_FILL_TEMP_GROUP_1: do j=1,VECTOR_GROUP_SIZES(k)
              VECTOR_TEMP2(j) = VECTOR_BETA(VECTOR_INDEX_START(k)+j-1) - t*VECTOR_GRADIENT(VECTOR_INDEX_START(k)+j-1)
            end do LOOP_FILL_TEMP_GROUP_1
            TEMP1 = t*real(n,rkdp)*ALPHA*LAMBDA*VECTOR_OMEGA_GROUP(k)
            call ROUTINE_SOFT_THRESHOLDING_SCALAR(VECTOR_GROUP_SIZES(k), TEMP1, VECTOR_TEMP2, VECTOR_TEMP1)
            
            TEMP1 = t*real(n,rkdp)*(1.0_rkdp-ALPHA)*LAMBDA*VECTOR_OMEGA_GROUP(k)*sqrt(real(VECTOR_GROUP_SIZES(k),rkdp))
  ...
  end subroutine ROUTINE_SPARSE_GROUP_LASSO_PROX_GRAD_BACK_WARM
end module MODULE_TOP_SPARSE_GROUP_LASSO