...
initial_dir = getwd()
setwd("C:/Users/klosa/Desktop/Seattle_Documentation/5.2-Modified sparse-group lasso/modified_sparse-group_lasso/Output")

pdf("modified_sg_lasso_figures_f90.pdf", width=12, height=8)

#******************************************************************************
#*  Analysis tools.                                                           *
#******************************************************************************
beta_sim = as.matrix(read.table("beta_sim.txt", header = FALSE, sep = " ", dec = "."))
beta     = as.matrix(read.table("modified_sg_lasso_output_f90_beta.txt", header = FALSE, dec = "."))
